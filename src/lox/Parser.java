...
//************************************
    ...
    /**
     * Checks if the next token matches any of the provided types.
     * If a match is found, it advances the current token index.
    ...
    /**
     * Checks if the parser is at the end of the token list.
     ...
     * This is used to get the last token that was processed before the current one.
     * @return the previous token
     */
     ...
     * @throws ParseError if the token does not match the specified type
     */
    ...
    /**
     * Generates a parse error with the specified token and message.
    ...
    /**
     * Finishes parsing a function or method call expression.
     * @param callee the expression representing the function or method being called
     * @return a Call expression representing the function or method call
     */
